...
struct ConfigFieldTests {
    ...
    func `computes environment variable name from snake_case id`() {
        ...
        #expect(field.environmentVariableName == "SMARTQUOTA_MONTHLY_BUDGET")
    }
