...
| **中文名** | 智额 |
| **英文名** | SmartQuota |
| **macOS** | **0.3.24** (build 27) · 菜单栏 · Swift / Tuist · macOS 15+ |
...
**Release：** [v0.3.24](https://github.com/yancyfeng999-star/smartquota/releases/tag/v0.3.24)

| 文件 | 用法 |
|------|------|
| [SmartQuota-0.3.24.dmg](https://github.com/yancyfeng999-star/smartquota/releases/download/v0.3.24/SmartQuota-0.3.24.dmg) | 打开后把 **智额.app** 拖到 Applications（推荐） |
| [SmartQuota-0.3.24.pkg](https://github.com/yancyfeng999-star/smartquota/releases/download/v0.3.24/SmartQuota-0.3.24.pkg) | 双击安装向导 / 应用内一键静默更新 |
