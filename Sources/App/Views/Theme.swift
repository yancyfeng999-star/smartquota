...
enum ThemeMode: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .light: L10n.shared.t("settings.theme.light")
        case .dark: L10n.shared.t("settings.theme.dark")
        case .system: L10n.shared.t("settings.theme.system")
        case .cli: "CLI"
        case .christmas: "🎄"
        }
    }
