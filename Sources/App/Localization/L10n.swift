...
final class L10n {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "quota.5h": [.zhHans: "5小时", .en: "5H", .ja: "5時間", .ko: "5시간", .ru: "5ч", .ar: "5س", .fr: "5 h", .de: "5 Std.", .es: "5 h", .pt: "5 h"],
        "quota.monthly": [.zhHans: "总额", .en: "Total", .ja: "合計", .ko: "총량", .ru: "Итого", .ar: "الإجمالي", .fr: "Total", .de: "Gesamt", .es: "Total", .pt: "Total"],
        ...
        "quota.weekly": [.zhHans: "7天", .en: "7d", .ja: "7日", .ko: "7일", .ru: "7д", .ar: "7ي", .fr: "7 j", .de: "7 T.", .es: "7 d", .pt: "7 d"],
        ...
        "settings.bg_sync_help": [.zhHans: "后台保持菜单栏数据新鲜。选「关闭」则仅打开菜单时更新。最快一分钟一次。", .en: "Keep menu bar data fresh. Off = refresh only when menu opens. Fastest: every minute.", .ja: "メニューバーを最新に。オフはメニュー表示時のみ。最短1分。", .ko: "메뉴바 데이터를 최신으로. 끄면 메뉴 열 때만. 최단 1분.", .ru: "Актуальность меню. Выкл. = только при открытии. Мин. 1 минута.", .ar: "تحديث شريط القائمة. إيقاف = عند الفتح فقط. الأسرع: كل دقيقة.", .fr: "Données fraîches. Off = à l’ouverture. Min. 1 minute.", .de: "Menüleiste aktuell. Aus = nur beim Öffnen. Min. 1 Minute.", .es: "Datos frescos. Off = al abrir. Mín. 1 minuto.", .pt: "Dados atualizados. Off = ao abrir. Mín. 1 minuto."],
