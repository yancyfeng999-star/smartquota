...
/// Values are injected as environment variables (SMARTQUOTA_*) when probes execute.
public struct ConfigField: Sendable, Equatable, Codable {
    ...
    /// Converts the field id to SMARTQUOTA_UPPER_SNAKE_CASE.
    /// Examples: "apiKey" → "SMARTQUOTA_API_KEY", "base-url" → "SMARTQUOTA_BASE_URL"
