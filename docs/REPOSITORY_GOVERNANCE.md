...
本文档定义智额 · SmartQuota 的公开仓库协作、依赖、发布和隐私治理规则。当前 Mac 发布版本为 0.3.30（build 33），对应 [GitHub Release v0.3.30](https://github.com/yancyfeng999-star/smartquota/releases/tag/v0.3.30)。仓库自有代码、文档和脚本采用 [Apache License 2.0](../LICENSE)；第三方依赖、资源、商标和服务边界见 [NOTICE](../NOTICE)。
