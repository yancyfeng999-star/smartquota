...
final class L10n {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "onboard.refresh.needs_config": [
            .zhHans: "还需要配置：缺少 CLI、密钥或权限。",
            .en: "Still needs setup: missing CLI, key, or permission.",
        ...
        "onboard.refresh.next_config": [
            .zhHans: "下一步：打开配置或查看帮助，补齐 CLI、密钥或权限。",
            .en: "Next: open setup or help to add the CLI, key, or permission.",
            ...
            .pt: "Próximo: abra a configuração ou a ajuda para adicionar CLI, chave ou permissão.",
        ],
