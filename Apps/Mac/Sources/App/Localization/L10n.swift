...
final class L10n {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "settings.updates_manual_help": [
            .zhHans: "点一次检查更新：优先下载 .pkg 并静默安装后自动重启。无二次确认弹窗。",
            .en: "One tap: prefer .pkg, silent install, then relaunch. No confirmation dialogs.",
            .ja: "1回タップで .pkg を優先し、確認なしでインストール後に再起動します。",
            .ko: "한 번 탭: .pkg 우선 다운로드 후 확인 없이 설치·재실행.",
            .ru: "Один раз: .pkg, тихая установка, перезапуск. Без диалогов.",
            .ar: "نقرة واحدة: تفضيل .pkg وتثبيت صامت ثم إعادة التشغيل.",
            .fr: "Un clic : .pkg prioritaire, install silencieuse, relance. Sans dialogues.",
            .de: "Ein Klick: .pkg bevorzugt, stille Installation, Neustart. Keine Dialoge.",
            .es: "Un toque: .pkg preferido, instalación silenciosa y reinicio. Sin diálogos.",
            .pt: "Um toque: prefere .pkg, instalação silenciosa e reabertura. Sem diálogos.",
        ],
