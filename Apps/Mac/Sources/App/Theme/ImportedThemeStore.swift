...
/// Persists imported terminal color schemes as JSON files in `~/.smartquota/themes/`.
///
...
public final class ImportedThemeStore {
    ...
    /// - Parameter directory: Override for the themes directory. Defaults to `~/.smartquota/themes/`.
    ...
    private static func defaultDirectory() -> URL {
        ...
        return AppIdentity.themesDirectoryURL
    }
