...
struct CopilotConfigCard: View {
    ...
    var body: some View {
        SettingsExpandableCard(isExpanded: $copilotIsExpanded) {
            copilotHeader
        } content: {
            copilotForm
        }
    ...
    private var copilotHeader: some View {
        HStack(spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text(L10n.shared.t("config.copilot"))
                    .font(.system(size: 14, weight: .bold, design: theme.fontDesign))
                    .foregroundStyle(theme.textPrimary)

                Text(L10n.shared.t("config.subtitle.credits"))
    ...
    private var copilotForm: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            if copilotProbeMode == .billing {
                VStack(alignment: .leading, spacing: 6) {
                    Text(L10n.shared.t("config.copilot.username"))
                        .font(.system(size: 9, weight: .semibold, design: theme.fontDesign))
                        .foregroundStyle(theme.textSecondary)
                        .tracking(0.5)
            ...
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    Text(L10n.shared.t("config.copilot.token"))
                        .font(.system(size: 9, weight: .semibold, design: theme.fontDesign))
                        .foregroundStyle(theme.textSecondary)
                        .tracking(0.5)
                ...
                if let error = saveError {
                    ...
                    HStack(spacing: 4) {
                        Image(systemName: "checkmark.circle.fill")
                            .font(.system(size: 9))
                        Text(L10n.shared.t("config.copilot.token_saved"))
                            .font(.system(size: 9, weight: .semibold, design: theme.fontDesign))
                    }
                    .foregroundStyle(theme.statusHealthy)
                }
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text(L10n.shared.t("config.copilot.env"))
                    .font(.system(size: 9, weight: .semibold, design: theme.fontDesign))
                    .foregroundStyle(theme.textSecondary)
                    .tracking(0.5)
            ...
            if copilotProbeMode == .billing {
                // Monthly Limit
                VStack(alignment: .leading, spacing: 6) {
                    Text(L10n.shared.t("config.copilot.monthly"))
                        .font(.system(size: 9, weight: .semibold, design: theme.fontDesign))
                        .foregroundStyle(theme.textSecondary)
                        .tracking(0.5)
                ...
                if copilotApiReturnedEmpty {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Link(destination: URL(string: "https://github.com/settings/copilot/features") ?? URL(fileURLWithPath: "/")) {
                            HStack(spacing: 4) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                if copilotProbeMode == .billing {
                    ...
                    Link(destination: URL(string: "https://github.com/settings/tokens?type=beta") ?? URL(fileURLWithPath: "/")) {
                        HStack(spacing: 3) {
                    ...
                    Link(destination: URL(string: "https://github.com/settings/tokens/new") ?? URL(fileURLWithPath: "/")) {
                        HStack(spacing: 3) {
