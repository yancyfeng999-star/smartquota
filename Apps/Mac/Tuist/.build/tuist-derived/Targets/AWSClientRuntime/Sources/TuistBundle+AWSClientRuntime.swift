...
/// Since AWSClientRuntime is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "aws-sdk-swift_AWSClientRuntime"
        ...
        fatalError("unable to find bundle named aws-sdk-swift_AWSClientRuntime")
    }()
}
