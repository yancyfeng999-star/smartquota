...
/// Since ClientRuntime is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "smithy-swift_ClientRuntime"
        ...
        fatalError("unable to find bundle named smithy-swift_ClientRuntime")
    }()
}
