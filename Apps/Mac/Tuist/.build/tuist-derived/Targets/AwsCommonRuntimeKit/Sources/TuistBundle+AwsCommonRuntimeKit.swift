...
/// Since AwsCommonRuntimeKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "aws-crt-swift_AwsCommonRuntimeKit"
        ...
        fatalError("unable to find bundle named aws-crt-swift_AwsCommonRuntimeKit")
    }()
}
